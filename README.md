...
Hawkeye is a Viam-powered RC car that tracks tennis balls. It's built on top of the Waveshare PiRacer Pro kit using Viam software to control the hardware.
...
The Raspberry Pi and `viam-agent` take 30-40 seconds to finish booting. You'll then see the Viam logo on the screen along with a longer beep indicating that the ESC is armed.
